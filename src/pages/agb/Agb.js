...
class Agb extends Component {
  render() {
    ...
    return (
      <>
        <Header theme={theme} />
        {/* <title>AGB – Sergey Tarasov</title> */}
        <h1>Allgemeine Geschäftsbedingungen (AGB)</h1>
        <p>
          <strong>Letzte Aktualisierung:</strong> 22. Juni 2025
        </p>

        <h2>1. Anbieterinformation</h2>
        <p>
        ...
        <p>
          ...
          zustande, wenn alle Bedingungen (Leistungsumfang, Preis, Lieferfrist)
          in der schriftlichen Kommunikation (z. B. WhatsApp) bestätigt wurden.
          Durch die Kontaktaufnahme über die Website oder einen Messenger
        ...
        <p>
          ...
          verpflichtet, alle notwendigen Informationen zur Verfügung zu stellen
          und Zahlungen fristgerecht zu leisten. Bei höherer Gewalt oder anderen
          unvorhergesehenen Ereignissen wird eine einvernehmliche Lösung
          angestrebt.
        </p>
